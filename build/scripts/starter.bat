...
set CLASSPATH=%APP_HOME%\lib\starter-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\vertx-web-4.0.3.jar;%APP_HOME%\lib\vertx-mysql-client-4.0.3.jar;%APP_HOME%\lib\vertx-lang-groovy-4.0.3.jar;%APP_HOME%\lib\vertx-web-common-4.0.3.jar;%APP_HOME%\lib\vertx-auth-common-4.0.3.jar;%APP_HOME%\lib\vertx-sql-client-4.0.3.jar;%APP_HOME%\lib\vertx-core-4.0.3.jar;%APP_HOME%\lib\vertx-bridge-common-4.0.3.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.60.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.60.Final.jar;%APP_HOME%\lib\netty-handler-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-4.1.60.Final.jar;%APP_HOME%\lib\netty-transport-4.1.60.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.60.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.60.Final.jar;%APP_HOME%\lib\netty-common-4.1.60.Final.jar;%APP_HOME%\lib\jackson-core-2.11.3.jar;%APP_HOME%\lib\groovy-json-3.0.7.jar;%APP_HOME%\lib\groovy-3.0.7.jar
